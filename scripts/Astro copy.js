Astro = function()
{
	...
	{
		return rotate2(axis,cosd(angle),sind(angle),coords);
	}
...
Orbiter = function(name)
{
	...
	Orbiter.prototype.m_N = function(i) {return 0;}
	Orbiter.prototype.m_i = function(i) {return 0;}
	Orbiter.prototype.m_w = function(i) {return 0;}
	Orbiter.prototype.m_a = function(i) {return 0;}
	Orbiter.prototype.m_e = function(i) {return 0;}
	Orbiter.prototype.m_M = function(i) {return 0;}
	
	this.m_nIter = 30;
	this.m_dPrecision = 1e-4;

	Orbiter.prototype.get_N = function(d) {return this.astro.mod360(this.m_N(0) + this.m_N(1)*d);}
	Orbiter.prototype.get_i = function(d) {return this.astro.mod360(this.m_i(0) + this.m_i(1)*d);}
	Orbiter.prototype.get_w = function(d) {return this.astro.mod360(this.m_w(0) + this.m_w(1)*d);}
	Orbiter.prototype.get_a = function(d) {return this.m_a(0) + this.m_a(1)*d;}
	Orbiter.prototype.get_e = function(d) {return this.m_e(0) + this.m_e(1)*d;}
	Orbiter.prototype.get_M = function(d) {return this.astro.mod360(this.m_M(0) + this.m_M(1)*d);}

	Orbiter.prototype.GetMeanAnomaly = function(d) {return this.astro.mod360(this.m_M(0) + this.m_M(1)*d);}
	Orbiter.prototype.GetPerihelionArgument = function(d) {return this.astro.mod360(this.m_w(0) + this.m_w(1)*d);}
	...
	Orbiter.prototype.GetPeriod = function(d) {return Math.pow(this.m_a(0)+this.m_a(1)*d, 1.5);}
...
Sun = function()
{
	...
	Sun.prototype.m_N = function(i) {return 0;}
	Sun.prototype.m_i = function(i) {return 0.0;}
	Sun.prototype.m_w = function(i) {return i==0 ? 282.9404 : 4.70935E-5;} 
	Sun.prototype.m_a = function(i) {return i==0 ? 1.000000 : 0;}
	Sun.prototype.m_e = function(i) {return i==0 ? 0.016709 : -1.151E-9;}
	Sun.prototype.m_M = function(i) {return i==0 ? 356.0470 : 0.9856002585;} 
...
Moon = function()
{
	...
	Moon.prototype.m_N  = function(i) {return i==0 ? 125.1228 : -0.0529538083;} 
	Moon.prototype.m_i = function(i) {return i==0 ? 5.1454 : 0;}
	Moon.prototype.m_w = function(i) {return i==0 ? 318.0634 : 0.1643573223;}
	Moon.prototype.m_a = function(i) {return i==0 ? 60.2666 : 0;}
	Moon.prototype.m_e = function(i) {return i==0 ? 0.054900 : 0;}
	Moon.prototype.m_M = function(i) {return i==0 ? 115.3654 : 13.0649929509;}
...
Mercury = function()
{
	...
	Mercury.prototype.m_N = function(i) {return i==0 ? 48.3313 : 3.24587E-5;}
	Mercury.prototype.m_i = function(i) {return i==0 ? 7.0047 : 5.00E-8;}
	Mercury.prototype.m_w = function(i) {return i==0 ? 29.1241 : 1.01444E-5;}
	Mercury.prototype.m_a = function(i) {return i==0 ? 0.387098 : 0;}
	Mercury.prototype.m_e = function(i) {return i==0 ? 0.205635 : 5.59E-10;}
	Mercury.prototype.m_M = function(i) {return i==0 ? 168.6562 : 4.0923344368;}
}
...
Venus = function()
{
	...
	this.m_N = function(i) {return i==0 ? 76.6799 : 2.46590E-5;}
	this.m_i = function(i) {return i==0 ? 3.3946 : 2.75E-8;}
	this.m_w = function(i) {return i==0 ? 54.8910 : 1.38374E-5;}
	this.m_a = function(i) {return i==0 ? 0.723330 : 0;}
	this.m_e = function(i) {return i==0 ? 0.006773 : -1.302E-9;}
	this.m_M = function(i) {return i==0 ? 48.0052 : 1.6021302244;}
}
...
Earth = function()
{
	...
	this.m_N = function(i) {return i==0 ? 0 : 0;}
	this.m_i = function(i) {return i==0 ? 0 : 0;}
	this.m_w = function(i) {return i==0 ? 102.9404 : 4.70935e-5;}
	this.m_a = function(i) {return i==0 ? 1.00000018 : 0;}
	this.m_e = function(i) {return i==0 ? 0.016709 : -1.151e-9;}
	this.m_M = function(i) {return i==0 ? 356.0470 : 0.9856002585;}
}
...
Mars = function()
{
	...
	this.m_N = function(i) {return i==0 ? 49.5574 : 2.11081E-5;}
	this.m_i = function(i) {return i==0 ? 1.8497 : 1.78E-8;}
	this.m_w = function(i) {return i==0 ? 286.5016 : 2.92961E-5;}
	this.m_a = function(i) {return i==0 ? 1.523688 : 0;}
	this.m_e = function(i) {return i==0 ? 0.093405 : 2.516E-9;}
	this.m_M = function(i) {return i==0 ? 18.6021 : 0.5240207766;}
}
...
Jupiter = function()
{
	...
	Jupiter.prototype.m_N = function(i) {return i==0 ? 100.4542 : 2.76854E-5;}
	Jupiter.prototype.m_i = function(i) {return i==0 ? 1.3030 : -1.557E-7;}
	Jupiter.prototype.m_w = function(i) {return i==0 ? 273.8777 : 1.64505E-5;}
	Jupiter.prototype.m_a = function(i) {return i==0 ? 5.20256 : 0;}
	Jupiter.prototype.m_e = function(i) {return i==0 ? 0.048498 : 4.469E-9;}
	Jupiter.prototype.m_M = function(i) {return i==0 ? 19.8950 : 0.0830853001;}
...
Saturn = function()
{
	...
	Saturn.prototype.m_N = function(i) {return i==0 ? 113.6634 : 2.38980E-5;}
	Saturn.prototype.m_i = function(i) {return i==0 ? 2.4886 : -1.081E-7;}
	Saturn.prototype.m_w = function(i) {return i==0 ? 339.3939 : 2.97661E-5;}
	Saturn.prototype.m_a = function(i) {return i==0 ? 9.55475 : 0;}
	Saturn.prototype.m_e = function(i) {return i==0 ? 0.055546 : -9.499E-9;}
	Saturn.prototype.m_M = function(i) {return i==0 ? 316.9670 : 0.0334442282;}
...
Uranus = function()
{
	...
	this.m_N = function(i) {return i==0 ? 74.0005 : 1.3978E-5;}
	this.m_i = function(i) {return i==0 ? 0.7733 : 1.9E-8;}
	this.m_w = function(i) {return i==0 ? 96.6612 : 3.0565E-5;}
	this.m_a = function(i) {return i==0 ? 19.18171 : - 1.55E-8;}
	this.m_e = function(i) {return i==0 ? 0.047318 : 7.45E-9;}
	this.m_M = function(i) {return i==0 ? 142.5905 : 0.011725806;}
}
...
Neptune = function()
{
	...
	this.m_N = function(i) {return i==0 ? 131.7806 : 3.0173E-5;}
	this.m_i = function(i) {return i==0 ? 1.7700 : -2.55E-7;}
	this.m_w = function(i) {return i==0 ? 272.8461 : -6.027E-6;}
	this.m_a = function(i) {return i==0 ? 30.05826 : 3.313E-8;}
	this.m_e = function(i) {return i==0 ? 0.008606 : 2.15E-9;}
	this.m_M = function(i) {return i==0 ? 260.2471 : 0.005995147;}
}
